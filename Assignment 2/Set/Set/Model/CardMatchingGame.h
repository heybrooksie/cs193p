...
- (id)initWithCardCount:(NSUInteger)count usingDeck:(Deck *)deck initWithMatchesInGame:(int)matchNcards usingMatchBonus:(NSUInteger)matchBonusIn usingMismatchPenalty:(NSUInteger)mismatchPenaltyIn usingFlipCost:(NSUInteger)flipCostIn;
